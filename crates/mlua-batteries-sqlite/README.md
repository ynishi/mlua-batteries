...
mlua-batteries-sqlite = "0.5"          # see "Choosing a version"
tokio = { version = "1", features = ["rt", "macros"] }
```

```rust,ignore
use mlua_batteries_sqlite::rusqlite_isle::AsyncIsle;
...
| `mlua-batteries-sqlite` | `rusqlite-isle` | `rusqlite` | `libsqlite3-sys` |
|---|---|---|---|
| `0.5` | 0.5 | 0.37 | 0.35 |
